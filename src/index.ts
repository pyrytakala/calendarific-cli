...
import { holidaysResource } from "./resources/holidays.js";
...
program
  ...
  .description("CLI for the calendarific API")
  .version("0.1.0")
...
// Resources
program.addCommand(holidaysResource);
program.addCommand(countriesResource);
